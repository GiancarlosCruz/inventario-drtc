<div class="login-container">
    <div class="login-content">
        <p class="text-center">
            <img src="<?php echo SERVERURL;?>vistas/assets/avatar/drtc-apurimac.png" width="130" height="130" class="img-fluid " alt="">
        </p>
        <p class="text-center">
        ...
        <form action="" method="POST" autocomplete="off" >
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="UserPassword" name="clave_log" pattern="[a-zA-Z0-9$@.-]{4,100}" maxlength="100" required="" >
            </div>
